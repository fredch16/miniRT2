...
/*   Updated: 2025/12/16 19:06:00 by fredchar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
inline t_mat	mat(const t_vec col0, const t_vec col1,
	const t_vec col2, const t_vec col3)
{
	return ((t_mat){{col0, col1, col2, col3}});
}

inline t_mat	mat_idt(void)
{
	return ((t_mat){{vector(1, 0, 0), vector(0, 1, 0),
